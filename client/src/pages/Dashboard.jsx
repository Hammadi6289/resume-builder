...
const Dashboard = () => {
  ...
  const deleteResume = async (resumeId) => {
    const confirm = window.confirm(
      "This will remove this resume from your account."
    );
    if (confirm) {
            ...
            w-full px-4 py-2 mb-4 focus:border-green-600 ring-green-600"
              ...
              <div>
                ...
                >
                  ...
                  border group text-slate-400 border-slate-400 border-dashedrounded-md p-4 py-10 my-4 hover:border-green-500
